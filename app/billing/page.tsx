      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <section className="mb-12">
          <div className="flex flex-wrap gap-2 mb-4">
            <Link className="text-[#A0A0B0] text-base font-medium hover:text-white" href="#">Dashboard</Link>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {subscriptionPlans.map((plan) => (
              <SubscriptionPlan key={plan.name} {...plan} />
            ))}
          </div>
        </section>
              ...
              <table className="w-full min-w-[600px] text-left">
                ...
                <tbody>
                  {billingHistory.map((row) => (
                    <BillingHistoryRow key={row.date} {...row} />
                  ))}
                </tbody>
              </table>
            </div>
