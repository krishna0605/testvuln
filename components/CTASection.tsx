...
const CTASection = () => {
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="rounded-xl p-10 md:p-16 flex flex-col items-center justify-center text-center gap-6"
      style={{background: 'linear-gradient(45deg, #0d9be7, #101c22)'}}
    >
      <h2 className="text-white text-3xl md:text-4xl font-bold leading-tight tracking-tighter max-w-lg">
        Ready to Secure Your Applications?
      </h2>
      <p className="text-white/80 max-w-md">
        Join thousands of developers and security professionals who trust VulnScanner to protect their digital assets.
      </p>
