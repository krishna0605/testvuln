            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-lg">
              <div className="flex flex-col gap-8">
                ...
                <form className="flex flex-col gap-4">
                  ...
                  <button className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-11 px-5 flex-1 bg-vuln-accent text-white text-base font-bold leading-normal tracking-wide transition-shadow hover:shadow-[0_0_20px_theme(colors.vuln-accent)]">
